...
import { obtenerBodegas, obtenerTrabajadores, type Bodega, type Trabajador } from "../servicios/trabajadoresApi";
import {
  actualizarTarea,
  crearTarea,
  PRIORIDADES,
...
import styles from "./registrar-trabajador.module.css";
