...
import { registrarIngreso } from "../servicios/ingresosApi";
import { listarBodegas } from "../servicios/bodegasApi";
import { obtenerCategorias } from "../servicios/materialesApi";
import styles from "./ingreso-form.module.css";
