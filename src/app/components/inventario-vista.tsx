...
import { IndicadorStock, ChipStock } from "./indicador-stock";
import { AjusteModal } from "./ajuste-modal";
import { MermaModal } from "./merma-modal";
import { LineaConfigurarModal } from "./linea-configurar-modal";
import { listarInventario, type LineaInventario } from "../servicios/inventarioApi";
import { listarBodegas, type Bodega } from "../servicios/bodegasApi";
import styles from "./inventario-vista.module.css";
