import logoMarcaAgua from "../public/icons/logo-1-recyops.svg?raw";
import faviconRecyops from "../public/icons/favicon-recyops.svg?raw";
import { obtenerIngresoPorUuid, type Ingreso } from "../servicios/ingresosApi";
