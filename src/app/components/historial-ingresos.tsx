...
import { obtenerHistorialIngresos, type Ingreso } from "../servicios/ingresosApi";
import { abrirReciboIngresoPorUuid } from "./recibo-ingreso";
import styles from "./historial-ingresos.module.css";
